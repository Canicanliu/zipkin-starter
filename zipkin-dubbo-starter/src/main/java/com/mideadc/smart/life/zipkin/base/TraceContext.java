package com.mideadc.smart.life.zipkin.base;


import com.mideadc.smart.life.zipkin.config.TraceConfig;
...
//    private static ThreadLocal<Long> TRACE_ID =new ThreadLocal<Long>();
//    private static ThreadLocal<Long> SPAN_ID = new ThreadLocal<Long>();
